...
from .views import book_list, create_book, update_book_details, book_detail, delete_book, update_book_status, book_list_sort
...
urlpatterns = [
    ...
    path(_("book_list_sort/<str:filter>/<str:direction>/"), book_list_sort, name="book_list_sort"),
]